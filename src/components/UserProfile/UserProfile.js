              ...
              <div>
                ...
                <div className="favorites">
                  {favorites.length !== 0 ? (
                    ...
                    <div>
                      <h4>Click the star icon on a recipe to add a favorite</h4>
...
const mapStateToProps = (state) => {
  return {
    recipeBooks: state.recipeReducer.recipeBooks,
    recipesFromDB: state.recipeReducer.recipeBooks,
    favorites: state.recipeReducer.favorites,
    trivia: state.recipeReducer.trivia,
    getRandomFoodTrivia: state.recipeReducer.getRandomFoodTrivia,
